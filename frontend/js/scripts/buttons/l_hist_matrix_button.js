$("#l_hist_button").click(function(){
	block_ui();
	check_if_ready("l_hist_button").then(() => {
		client.invoke("get_l_hist", get_selection_json(), (error, res) => {
			if (error) {
				console.error(error)
			} else {
				...
				$("#first_overlay_plot_text").text('L component histogram');
